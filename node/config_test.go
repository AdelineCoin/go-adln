...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "adln.ipc", false, filepath.Join(os.TempDir(), "adln.ipc")},
		{"data", "adln.ipc", false, "data/adln.ipc"},
		{"data", "./adln.ipc", false, "./adln.ipc"},
		{"data", "/adln.ipc", false, "/adln.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "adln.ipc", true, `\\.\pipe\adln.ipc`},
		{"data", "adln.ipc", true, `\\.\pipe\adln.ipc`},
		{"data", `\\.\pipe\adln.ipc`, true, `\\.\pipe\adln.ipc`},
	}
